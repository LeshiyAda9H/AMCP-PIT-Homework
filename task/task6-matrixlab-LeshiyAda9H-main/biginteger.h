...
public:
	...
	void upMinus(BigInteger& numerator) {
		numerator.sign = static_cast<char>(static_cast<int>(numerator.sign) * static_cast<int>(this->sign));
		this->sign = static_cast<char>(static_cast<int>(this->sign) * static_cast<int>(this->sign));
	}
